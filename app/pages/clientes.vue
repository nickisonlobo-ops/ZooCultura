<template>
  <div class="min-h-full bg-gray-50/60 p-3 sm:p-8">
    ...
    <div class="relative rounded-3xl overflow-hidden mb-8 shadow-xl">
      <div class="absolute inset-0 bg-gradient-to-br from-violet-900 via-violet-700 to-violet-500" />
      ...
      <div class="relative px-4 sm:px-8 pt-5 sm:pt-7 pb-5 sm:pb-7">
        <div class="flex flex-wrap items-start justify-between gap-3 sm:gap-6">
          <div class="flex items-center gap-3 sm:gap-5">
            ...
            <div>
              <div class="flex items-center gap-2 mb-1">
                <span class="text-xs font-semibold text-violet-300 uppercase tracking-widest">CRM</span>
                <span class="w-1 h-1 rounded-full bg-violet-400/50" />
                <span class="text-xs text-violet-300/70 hidden sm:inline">ZooCultura</span>
              </div>
              <h1 class="text-xl sm:text-3xl font-bold text-white tracking-tight leading-none">Clientes</h1>
              <p class="text-sm text-violet-200/80 mt-1.5">
          ...
          <div class="flex items-center gap-2 shrink-0">
            ...
            <button
              type="button"
              class="inline-flex items-center gap-2 text-sm font-bold px-3 sm:px-5 py-2.5 rounded-xl bg-white text-violet-800 hover:bg-violet-50 shadow-lg shadow-violet-900/25 transition-all duration-200 hover:scale-[1.02]"
        ...
        <div v-if="!loading" class="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <div class="flex flex-col gap-1 bg-white/10 backdrop-blur-sm rounded-2xl px-5 py-4 border border-white/10 hover:bg-white/15 transition-colors">
            <span class="text-xs font-semibold text-violet-300 uppercase tracking-widest">Total</span>
            <span class="text-xl font-black text-white leading-tight">{{ clientes.length }}</span>
            <span class="text-xs text-violet-300/60">cliente(s)</span>
          </div>
          ...
          <div class="flex flex-col gap-1 bg-white/[0.07] rounded-2xl px-5 py-4 border border-white/10 hover:bg-white/12 transition-colors">
            <span class="text-xs font-semibold text-violet-300 uppercase tracking-widest">Com E-mail</span>
            <span class="text-xl font-black text-white leading-tight">{{ comEmail }}</span>
            <span class="text-xs text-violet-300/60">de {{ clientes.length }} cadastrados</span>
          </div>
          <div class="flex flex-col gap-1 bg-white/[0.07] rounded-2xl px-5 py-4 border border-white/10 hover:bg-white/12 transition-colors">
            <span class="text-xs font-semibold text-violet-300 uppercase tracking-widest">Cidades</span>
            <span class="text-xl font-black text-white leading-tight">{{ cidadesUnicas.length }}</span>
            <span class="text-xs text-violet-300/60">distintas</span>
          </div>
        </div>
      </div>
    </div>
